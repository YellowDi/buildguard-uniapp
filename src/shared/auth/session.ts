...
export const DEMO_USERS: DemoUser[] = [
  {
    ...
    password: '123456',
    displayName: '张检修',
    avatarUrl: '/static/avatar-inspector-default.webp',
    role: 'inspector',
    demoMode: 'default',
    roleLabel: '检修身份',
  ...
  },
  {
    ...
    password: '123456',
    displayName: '周检修',
    avatarUrl: '/static/avatar-inspector-empty.webp',
    role: 'inspector',
    demoMode: 'empty',
    roleLabel: '检修空状态',
  ...
  },
  {
    ...
    password: '123456',
    displayName: '李电工',
    avatarUrl: '/static/avatar-maintainer-default.webp',
    role: 'maintainer',
    demoMode: 'default',
    specialty: 'electric',
    specialtyLabel: '电工',
  ...
  },
  {
    ...
    password: '123456',
    displayName: '孙水工',
    avatarUrl: '/static/avatar-maintainer-empty.webp',
    role: 'maintainer',
    demoMode: 'default',
    specialty: 'plumbing',
    specialtyLabel: '水工',
